# GLLYZI APP — Beta 3 style Patch editor
...
Incluye:
- GLLYZI APP branding y tema oscuro/rojo.
...
4. Ve a Actions > Build GLLYZI APP IPA.
5. Ejecuta Run workflow o espera el build automático del push.
6. Descarga el artifact GLLYZI-APP-unsigned.
